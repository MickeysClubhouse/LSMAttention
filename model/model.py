...
class FeatureEmbed(nn.Module):
    ...
    def forward(self, feature):
        ...
        typeId, joinId, filtersId, filtersMask, hists, table_sample = torch.split(feature,(1,1,15,5,self.bin_number*5,1001), dim=-1)
    ...
    def getHist(self, hists, filtersMask):
        # batch * 50 * 3
        histExpand = hists.view(-1, self.bin_number, 5).transpose(1, 2)  #todo
    ...
    def getFilter(self, filtersId, filtersMask):
        ...
        filterExpand = filtersId.view(-1, 3, 5).transpose(1, 2)  #todo
